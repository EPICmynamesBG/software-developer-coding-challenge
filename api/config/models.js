...
module.exports.models = {
  ...
  ***************************************************************************/
  ...
  attributes: {
    primaryKey: 'id',
    createdAtTimestamp: { type: 'number', autoCreatedAt: true, },
    updatedAtTimestamp: { type: 'number', autoUpdatedAt: true, },
    id: {
      type: 'string'
    },
    beforeCreate: function generateUUID(record, next) {
      const uuid = uuid.v4();
      record.id = uuid;
  ...
  ******************************************************************************/
  ...
  dataEncryptionKeys: {
    default: 'w2C1vqt+oDaz41tHSqyksAH8T6SsUq2xhrQDhvUVCQw='
  },
